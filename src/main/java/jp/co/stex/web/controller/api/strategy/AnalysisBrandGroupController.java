...
//     * 取引戦略サービス
//     */
//    private final IBrandGroupService analysisBrandGroupService;
//
//    /**
//     * ユーザサービス
//     */
...
//        return ResponseEntity.ok(analysisBrandGroupService.findAllAnalysisBrandGroup(1));
//    }
//
//    /**
//     * <p>分析対象銘柄を作成する。</p>
...
//        }
//        int gid = analysisBrandGroupService.createOneAnalysisBrandGroup(dozerMapper.map(form, AnalysisBrandGroupEntity.class).setUid(1));
...
//            throw new BindException(bd);
//        }
//        analysisBrandGroupService.updateOneAnalysisBrandGroup(dozerMapper.map(form, AnalysisBrandGroupEntity.class).setUid(1).setGid(gid));
...
//        analysisBrandGroupService.deleteOneAnalysisBrandGroup(1, gid);
//        return ResponseEntity.noContent().build();
//    }
//}
